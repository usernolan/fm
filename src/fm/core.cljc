...
(defmulti  ->metadata
  (fn
    ...
    ([_ctx tag] tag))
  :hierarchy #'metadata-hierarchy) ; TODO: atom
...
(defmethod ->metadata :default ; NOTE: default for unrecognized keys and `:fm/doc`
  [ctx tag]
...
(defmethod ->metadata :fm.metadata/default ; NOTE: default for recognized keys
  [ctx tag]
